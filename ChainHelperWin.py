...
try:
    apikeyHandle = open("api_key.txt", "r")
    api_key = apikeyHandle.read()
    apikeyHandle.close()
except:
    print("Place your TORN API key in api_key.txt file")
    time.sleep(5)
    exit(1)
...
while True:
    ...
    for user in users:
        ...
        if playerStatus == "Okay" and lastAction > 3600 * 2:
            ...
            webbrowser.open_new_tab("https://www.torn.com/profiles.php?XID=" + str(playerID))
